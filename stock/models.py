...
class ShoppingHistory(models.Model):
    ...
    gst = models.DecimalField(verbose_name='GST',max_digits=10,decimal_places=6,blank=True,null=True,default=0)
    pst = models.DecimalField(verbose_name='PST',max_digits=10,decimal_places=6,blank=True,null=True,default=0)
    bottle_deposit = models.DecimalField(verbose_name='ボトルデポジット',max_digits=10,decimal_places=6,blank=True,null=True,default=0)
    recycle_fee = models.DecimalField(verbose_name='リサイクルFee',max_digits=10,decimal_places=6,blank=True,null=True,default=0)
    drink_gst = models.DecimalField(verbose_name='Drink GST',max_digits=10,decimal_places=6,blank=True,null=True,default=0)
